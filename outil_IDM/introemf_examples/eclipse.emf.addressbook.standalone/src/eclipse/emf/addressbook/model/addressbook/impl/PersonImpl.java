...
public class PersonImpl extends EObjectImpl implements Person {
	...
	public void setFamilyName(String newFamilyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.PERSON__FAMILY_NAME, oldFamilyName, familyName));
	}
	...
	public NotificationChain basicSetLocation(Address newLocation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AddressbookPackage.PERSON__LOCATION, oldLocation, newLocation);
	...
	public void setLocation(Address newLocation) {
		if (newLocation != location) {
			...
			if (location != null)
				msgs = ((InternalEObject)location).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AddressbookPackage.PERSON__LOCATION, null, msgs);
			if (newLocation != null)
				msgs = ((InternalEObject)newLocation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AddressbookPackage.PERSON__LOCATION, null, msgs);
			msgs = basicSetLocation(newLocation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.PERSON__LOCATION, newLocation, newLocation));
	}
