 ...
 * <ul>
 *   <li>{@link eclipse.emf.addressbook.model.addressbook.impl.AddressBookImpl#getName <em>Name</em>}</li>
 *   <li>{@link eclipse.emf.addressbook.model.addressbook.impl.AddressBookImpl#getContains <em>Contains</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressBookImpl extends EObjectImpl implements AddressBook {
	 ...
	 * @ordered
	 */
	protected EList<Person> contains;
	 ...
	 * @generated
	 */
	public EList<Person> getContainsGen() {
		if (contains == null) {
			contains = new EObjectContainmentEList<Person>(Person.class, this, AddressbookPackage.ADDRESS_BOOK__CONTAINS);
		}
		return contains;
	}
	
	public EList<Person> getContains() {
		EList<Person> containsGen = this.getContainsGen();
		
		System.out.println("AddressBookImpl.getContains()");
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AddressbookPackage.ADDRESS_BOOK__CONTAINS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AddressbookPackage.ADDRESS_BOOK__CONTAINS:
				getContains().clear();
				getContains().addAll((Collection<? extends Person>)newValue);
				return;
		}
