...
public class AddressbookPackageImpl extends EPackageImpl implements AddressbookPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getAddressBook_Contains(), this.getPerson(), null, "contains", null, 0, -1, AddressBook.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPerson_Location(), this.getAddress(), null, "location", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(personEClass, ecorePackage.getEString(), "display", 0, 1, IS_UNIQUE, IS_ORDERED);
