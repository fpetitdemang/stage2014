/**
 */
package defaultname.PrimitiveTypes.impl;

import defaultname.DefaultnamePackage;

import defaultname.PrimitiveTypes.PrimitiveTypesFactory;
import defaultname.PrimitiveTypes.PrimitiveTypesPackage;

import defaultname.impl.DefaultnamePackageImpl;
...
public class PrimitiveTypesPackageImpl extends EPackageImpl implements PrimitiveTypesPackage {
	 ...
	 * @see defaultname.PrimitiveTypes.PrimitiveTypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static PrimitiveTypesPackage init() {
		...
		DefaultnamePackageImpl theDefaultnamePackage = (DefaultnamePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(DefaultnamePackage.eNS_URI) instanceof DefaultnamePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(DefaultnamePackage.eNS_URI) : DefaultnamePackage.eINSTANCE);
