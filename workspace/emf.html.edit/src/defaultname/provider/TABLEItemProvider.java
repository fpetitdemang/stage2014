...
/**
 * This is the item provider adapter for a {@link defaultname.TABLE} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TABLEItemProvider
	extends TABLEElementItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_border_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_border_feature", "_UI_TABLE_type"),
				 DefaultnamePackage.Literals.TABLE__BORDER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DefaultnamePackage.Literals.TABLE__WIDTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCellspacingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_cellspacing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_cellspacing_feature", "_UI_TABLE_type"),
				 DefaultnamePackage.Literals.TABLE__CELLSPACING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCellpaddingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TABLE_cellpadding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TABLE_cellpadding_feature", "_UI_TABLE_type"),
				 DefaultnamePackage.Literals.TABLE__CELLPADDING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DefaultnamePackage.Literals.TABLE__TRS);
		}
	...
	public String getText(Object object) {
		Object labelValue = ((TABLE)object).getValue();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DefaultnamePackage.Literals.TABLE__TRS,
				 DefaultnameFactory.eINSTANCE.createTR()));
	}
