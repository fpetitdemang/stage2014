...
/**
 * This is the item provider adapter for a {@link defaultname.OPTION} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OPTIONItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OPTION_selected_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OPTION_selected_feature", "_UI_OPTION_type"),
				 DefaultnamePackage.Literals.OPTION__SELECTED,
				 true,
				 false,
				 false,
	...
	protected void addOptionValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OPTION_optionValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OPTION_optionValue_feature", "_UI_OPTION_type"),
				 DefaultnamePackage.Literals.OPTION__OPTION_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Object labelValue = ((OPTION)object).getSelected();
