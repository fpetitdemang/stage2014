...
/**
 * This is the item provider adapter for a {@link defaultname.SELECT} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SELECTItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SELECT_multiple_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SELECT_multiple_feature", "_UI_SELECT_type"),
				 DefaultnamePackage.Literals.SELECT__MULTIPLE,
				 true,
				 false,
				 false,
	...
	protected void addSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SELECT_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SELECT_size_feature", "_UI_SELECT_type"),
				 DefaultnamePackage.Literals.SELECT__SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DefaultnamePackage.Literals.SELECT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Object labelValue = ((SELECT)object).getName();
