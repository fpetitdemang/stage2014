...
/**
 * This is the item provider adapter for a {@link defaultname.SPAN} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SPANItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SPAN_style_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SPAN_style_feature", "_UI_SPAN_type"),
				 DefaultnamePackage.Literals.SPAN__STYLE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Object labelValue = ((SPAN)object).getValue();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SPAN_type") :
