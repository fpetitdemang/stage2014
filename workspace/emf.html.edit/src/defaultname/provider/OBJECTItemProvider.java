...
/**
 * This is the item provider adapter for a {@link defaultname.OBJECT} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OBJECTItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OBJECT_classid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OBJECT_classid_feature", "_UI_OBJECT_type"),
				 DefaultnamePackage.Literals.OBJECT__CLASSID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DefaultnamePackage.Literals.OBJECT__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OBJECT_data_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OBJECT_data_feature", "_UI_OBJECT_type"),
				 DefaultnamePackage.Literals.OBJECT__DATA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DefaultnamePackage.Literals.OBJECT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStandbyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OBJECT_standby_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OBJECT_standby_feature", "_UI_OBJECT_type"),
				 DefaultnamePackage.Literals.OBJECT__STANDBY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Object labelValue = ((OBJECT)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OBJECT.class)) {
			case DefaultnamePackage.OBJECT__CLASSID:
			case DefaultnamePackage.OBJECT__ID:
			case DefaultnamePackage.OBJECT__DATA:
			case DefaultnamePackage.OBJECT__TYPE:
			case DefaultnamePackage.OBJECT__STANDBY:
