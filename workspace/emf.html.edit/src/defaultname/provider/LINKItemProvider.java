...
/**
 * This is the item provider adapter for a {@link defaultname.LINK} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LINKItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DefaultnamePackage.Literals.LINK__REL,
				 true,
				 false,
				 false,
	...
	protected void addAhrefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LINK_ahref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LINK_ahref_feature", "_UI_LINK_type"),
				 DefaultnamePackage.Literals.LINK__AHREF,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DefaultnamePackage.Literals.LINK__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Object labelValue = ((LINK)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LINK.class)) {
			case DefaultnamePackage.LINK__REL:
			case DefaultnamePackage.LINK__TITLE:
			case DefaultnamePackage.LINK__AHREF:
			case DefaultnamePackage.LINK__TYPE:
