...
public class SendObjectActionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlPackage.eINSTANCE.getSendObjectAction_Target());
			childrenFeatures.add(UmlPackage.eINSTANCE.getSendObjectAction_Request());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UmlPackage.eINSTANCE.getSendObjectAction_Request(),
				 UmlFactory.eINSTANCE.createInputPin()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == UmlPackage.eINSTANCE.getInvocationAction_Argument() ||
			childFeature == UmlPackage.eINSTANCE.getSendObjectAction_Target() ||
			childFeature == UmlPackage.eINSTANCE.getSendObjectAction_Request();
