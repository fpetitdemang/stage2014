...
public class BehavioralFeatureItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UmlPackage.eINSTANCE.getFeature_FeaturingClassifier(),
				 false,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlPackage.eINSTANCE.getBehavioralFeature_OwnedParameter());
			childrenFeatures.add(UmlPackage.eINSTANCE.getBehavioralFeature_OwnedParameterSet());
		}
