		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duration_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duration_expr_feature", "_UI_Duration_type"),
				 UmlPackage.eINSTANCE.getDuration_Expr(),
				 true,
				 false,
				 true,
				 null,
