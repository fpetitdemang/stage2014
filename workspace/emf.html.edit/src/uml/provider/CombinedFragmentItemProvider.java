...
public class CombinedFragmentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlPackage.eINSTANCE.getCombinedFragment_Operand());
			childrenFeatures.add(UmlPackage.eINSTANCE.getCombinedFragment_CfragmentGate());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UmlPackage.eINSTANCE.getCombinedFragment_CfragmentGate(),
