...
public class ArtifactItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlPackage.eINSTANCE.getArtifact_NestedArtifact());
			childrenFeatures.add(UmlPackage.eINSTANCE.getArtifact_Manifestation());
			childrenFeatures.add(UmlPackage.eINSTANCE.getArtifact_OwnedOperation());
			childrenFeatures.add(UmlPackage.eINSTANCE.getArtifact_OwnedAttribute());
		}
