...
\begin{document}
\tikzstyle{abstract}=[rectangle, draw=black, rounded corners, fill=pink!40, drop shadow,
        text centered, anchor=north, text=white, text width=3cm]
\tikzstyle{concret}=[rectangle, draw=black, rounded corners, fill=orange!40, drop shadow,
        text centered, anchor=north, text=white, text width=3cm]
...
\begin{tikzpicture}[node distance=2cm]
    \node (ROLE) [abstract, rectangle split, rectangle split parts=2]
        {
            \textit{ROLE}
            \nodepart{second}name
        };
    \node (AuxNode01) [text width=4cm, below=of ROLE] {};
    \node (Component) [concret, rectangle split, rectangle split parts=2, left=of AuxNode01]
        {
            \textbf{COMPONENT}
            \nodepart{second}nil
        };
    ...
    \draw[myarrow] (Component.north) -- ++(0,0.9) -| (ROLE.south);
